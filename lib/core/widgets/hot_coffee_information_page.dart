                         ...
                         return Column(
                            ...
                            children: [
                              ...
                              RadioListTile<String>(
                                ...
                                title: Text("Oat Milk (₹${getProvider.milkPrices[getProvider.selectedSize.isEmpty ? 'S' : getProvider.selectedSize]!['oat']})"),
                                value: 'oat',
                                groupValue: getProvider.selectedMilk,
                                onChanged: getProvider.selectedSize.isEmpty ? null : getProvider.selectMilk,
                                activeColor: Colors.teal,
                                tileColor: Colors.transparent,
                              ),
                              RadioListTile<String>(
                                // title: Text("Fat Milk (₹${getProvider.milkPrices[getProvider.selectedSize.isEmpty ? 'S' : getProvider.selectedSize]!['oat']})"),
                                // //Text("Fat Milk (₹275)"),
                                // value: 'fat',
                                // groupValue: getProvider.selectedMilk,
                                // onChanged: getProvider.selectMilk,
                                ...
                                // onChanged: getProvider.selectedSize.isEmpty ? null : getProvider.selectMilk,
                                 ...
                                 title:  Text("Fat Milk (₹${getProvider.milkPrices[getProvider.selectedSize.isEmpty ? 'S' : getProvider.selectedSize]!['fat']})"),
                                value: 'fat',
                                groupValue: getProvider.selectedMilk,
                                onChanged: getProvider.selectedSize.isEmpty ? null : getProvider.selectMilk,
                                activeColor: Colors.teal,
                              ...
                              RadioListTile<String>(
                                // title:Text("Heavy Cream (₹300)"),
                                // value: 'cream',
                                // groupValue: getProvider.selectedMilk,
                                // onChanged: getProvider.selectMilk,

                                title: Text("Heavy Cream (₹${getProvider.milkPrices[getProvider.selectedSize.isEmpty ? 'S' : getProvider.selectedSize]!['cream']})"),
                                value: 'cream',
                                groupValue: getProvider.selectedMilk,
                                onChanged: getProvider.selectedSize.isEmpty ? null : getProvider.selectMilk,
