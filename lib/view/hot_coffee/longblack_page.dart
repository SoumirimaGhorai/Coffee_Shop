...
class LongblackPage extends StatelessWidget {
  const LongblackPage({super.key});
            ...
            child: Column(
                children:[
                  Hero(tag: 'dash',
                    child:Column(
                      children: [
                        ClipRRect(borderRadius: BorderRadius.circular(35),child: Image.asset('lib/images/longblack.png'),),

                        //-------------------------------hero image-----------------------------------------------------------------

                        Text('Longblack',style: TextStyle(fontSize:20,fontWeight: FontWeight.w800),),],),),
