...
class MochaPage extends StatelessWidget {
  const MochaPage({super.key});
            ...
            child: Column(
                children:[
                  Hero(tag: 'dash',
                    child:Column(
                      children: [
                        ClipRRect(borderRadius: BorderRadius.circular(35),child: Image.asset('lib/images/mocha.png',),),

                        //-------------------------------hero image-----------------------------------------------------------------

                        Text('Mocha',style: TextStyle(fontSize:20,fontWeight: FontWeight.w800),),],),),
