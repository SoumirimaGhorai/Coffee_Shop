...
class CappuccinoPage extends StatelessWidget {
        ...
        Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.start,
              children: [SizedBox(width: 80,),
                ElevatedButton(onPressed:(){},style: ElevatedButton.styleFrom( backgroundColor: Colors.white,minimumSize:Size(5,50)), child:Text('Buy Now',style: TextStyle(color:Colors.orange),))]),
